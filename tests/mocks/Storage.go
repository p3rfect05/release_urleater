...
func (_m *Storage) GetTotalUserLinksNumber(ctx context.Context, email string) (int, error) {
...
func (_m *Storage) UpdateUserLinks(ctx context.Context, email string, newUrlsNumber int) (*postgresDB.User, error) {
